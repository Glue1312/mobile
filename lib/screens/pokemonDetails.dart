...
class _PokemonDetailsState extends State<PokemonDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: MyAppBar(title: 'Detail Pokemon')),
        body: Center(
          child: Stack(
            children: [
              Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                StatusBar(
                    title: 'Serangan Spesial',
                    color: widget.pokemon!.color,
                    size: size,
                    value: widget.pokemon!.stats[3]['base_stat']),
                StatusBar(
                    title: 'Defence Spesial',
                    color: widget.pokemon!.color,
                    size: size,
  ...
  Widget showContent() {
    ...
    return CustomFutureBuilder<List<Pokemon>>(
            ...
            ? Container(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Text(
                      'Tidak ada Pokémon untuk ditampilkan',
                      textAlign: TextAlign.center,
                      style:
      ...
      onEmpty: ((context) {
        return Center(child: Text('Tidak ada Pokémon untuk ditampilkan'));
      }),
      onLoading: ((context) {
        var size = MediaQuery.of(context).size;
        return Column(
          ...
          children: [
            ...
            AnimationPokebola(
                legend: 'Memuat...', color: widget.pokemon!.color),
          ],
        );
      }),
